...
constexpr float INSPECTOR_SLIDER_TRACK_HEIGHT = 3.0f;
/// Negative values move the track line upward within the slider row.
constexpr float INSPECTOR_SLIDER_TRACK_Y_OFFSET = -2.0f;
