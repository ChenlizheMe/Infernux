 ...
 * @brief Extracted shader-module and SPIR-V code cache from InfVkCoreModular.
 *
 * Owns VkShaderModule handles, raw SPIR-V code bytes, shader render-state
 * annotations, and the ShaderProgramCache.  InfVkCoreModular delegates
