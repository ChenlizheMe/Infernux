"""Tests for InfEngine.engine.deferred_task — DeferredTaskRunner."""
...
def _stub_engine_status(monkeypatch):
    ...
    fake_status = types.ModuleType("InfEngine.engine.ui.engine_status")
    ...
    monkeypatch.setitem(sys.modules, "InfEngine.engine.ui.engine_status", fake_status)
    yield EngineStatus
