...
class MeshImportSettings:
    ...
    animation_sample_rate: float = ...
    animation_position_error: float = ...
    animation_rotation_error: float = ...
    animation_scale_error: float = ...
    normal_mode: str = ...
    tangent_mode: str = ...
    normal_weighting: str = ...
    normal_smoothing_source: str = ...
    tangent_algorithm: str = ...
    flip_uvs: bool = ...
    swap_uv_channels: bool = ...
    optimize_mesh: bool = ...
    weld_vertices: bool = ...
    sort_hierarchy_by_name: bool = ...
    import_visibility: bool = ...
    convert_units: bool = ...
    bake_axis_conversion: bool = ...
    is_readable: bool = ...
    generate_colliders: bool = ...
    import_blend_shapes: bool = ...
    material_remaps: Dict[str, str] = ...
    rig_type: str = ...
    skeleton_definition_mode: str = ...
    rig_root_node: str = ...
    skeleton_definition_guid: str = ...
    skeleton_definition_id: str = ...
    optimize_bone_hierarchy: bool = ...
    exposed_bones: List[str] = ...
    humanoid_bone_overrides: Dict[str, str] = ...
    import_animations: bool = ...
    animation_loop_time: bool = ...
    animation_apply_root_motion: bool = ...
    animation_reference_pose: str = ...
    custom_animation_clips: bool = ...
    animation_clips: List[Dict[str, Any]] = ...
    animation_clip_extras: List[Dict[str, Any]] = ...
