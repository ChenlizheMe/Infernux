...
class Camera(BuiltinComponent):
    ...
    @use_physical_properties.setter
    def use_physical_properties(self, value: bool) -> None: ...
    ...
    def shutter_speed(self, value: float) -> None: ...
    ...
    @blade_count.setter
    def blade_count(self, value: int) -> None: ...

    @property
    def curvature(self) -> Any: ...
    @curvature.setter
    def curvature(self, value: Any) -> None: ...

    @property
    def barrel_clipping(self) -> float: ...
    @barrel_clipping.setter
    def barrel_clipping(self, value: float) -> None: ...

    @property
    def anamorphism(self) -> float: ...
    @anamorphism.setter
    def anamorphism(self, value: float) -> None: ...
    ...
    @property
    def sensor_type(self) -> Any:
        """Derived Unity sensor-size preset; Custom is not serialized."""
        ...
    @sensor_type.setter
    def sensor_type(self, value: Any) -> None: ...
