...
class Engine:
    ...
    def pick_scene_object_ids(self, screen_x: float, screen_y: float, viewport_width: float, viewport_height: float) -> List[int]:
        ...
        ...
    def pick_scene_icon_object_ids(self, screen_x: float, screen_y: float, viewport_width: float, viewport_height: float) -> List[int]: ...
    ...
    def get_play_mode_manager(self) -> PlayModeManager:
        ...
        ...
    def get_player_runtime(self) -> Any: ...
    def get_runtime_execution_scheduler(self) -> Any: ...
    def get_runtime_change_journal(self) -> Any: ...
