...
class PrefabApplyOverridesCommand(UndoCommand):
    def __init__(self, capture_state: Any, apply_overrides: Any, restore_state: Any, description: str = "Apply Prefab Overrides", *, scene_world_ids: Any = None, validate_replay: Any = None) -> None: ...
    def execute(self) -> None: ...
    def undo(self) -> None: ...
    def redo(self) -> None: ...
