...
GIZMO_CENTER_ID: int
GIZMO_RECT_LEFT_ID: int
GIZMO_RECT_RIGHT_ID: int
GIZMO_RECT_BOTTOM_ID: int
GIZMO_RECT_TOP_ID: int
GIZMO_RECT_BOTTOM_LEFT_ID: int
GIZMO_RECT_BOTTOM_RIGHT_ID: int
GIZMO_RECT_TOP_LEFT_ID: int
GIZMO_RECT_TOP_RIGHT_ID: int
GIZMO_RECT_CENTER_ID: int
...
class LightColorMode(IntEnum):
    Color: int
    FilterAndTemperature: int
...
class InxMesh:
    def create_model_node_copy(self, path: List[str]) -> InxMesh: ...
    def require_model_node(self, path: List[str]) -> int: ...
    def get_model_node_path(self, index: int) -> List[str]: ...
    ...
    @property
    def morph_target_names(self) -> List[str]: ...
    def get_morph_target_data(self, index: int) -> Dict[str, Any]: ...
    @property
    def material_slot_count(self) -> int: ...
    @property
    def material_slot_names(self) -> List[str]: ...
    def get_model_nodes(self) -> List[Dict[str, Any]]: ...
    @property
    ...
    def get_vertex_data(self) -> Dict[str, np.ndarray]: ...
...
class InxTexture:
    ...
    @property
    def bake_basis(self) -> Tuple[float, ...]: ...
    @property
    def value_min(self) -> Tuple[float, ...]: ...
    @property
    def value_max(self) -> Tuple[float, ...]: ...
...
class Light(Component):
    ...
    effective_color: Vector3
    effective_linear_color: Vector3
    intensity: float
    range: float
    spot_angle: float
...
class PyComponentProxy(Component):
    def _reset_lifecycle_for_play(self) -> None: ...
...
class Camera(Component):
    ...
    projection_matrix: Any  # NumPy float32 (4,4), [row,column], LH/ZO/Y-down
    @property
    def view_matrix(self) -> Any: ...
    @view_matrix.setter
    def view_matrix(self, value: Any) -> None: ...
    @property
    def camera_to_world_matrix(self) -> Any: ...
    @property
    ...
    def screen_point_to_ray(self, x: float, y: float, viewport_width: Optional[float] = ..., viewport_height: Optional[float] = ...) -> Tuple[Vector3, Vector3]: ...
    def serialize(self) -> str: ...
    def deserialize(self, json_str: str) -> None: ...
...
class AudioEngine:
    ...
    @property
    def active_listener_game_object_id(self) -> int: ...
    master_volume: float
    max_real_voices: int
    @property
    def real_voice_count(self) -> int: ...
    @property
    ...
    def fade_bus_volume(self, bus_name: str, volume: float, duration: float) -> None: ...
    def cancel_bus_fade(self, bus_name: str) -> None: ...
    def is_bus_fading(self, bus_name: str) -> bool: ...
    def set_bus_muted(self, bus_name: str, muted: bool) -> None: ...
    def get_bus_muted(self, bus_name: str) -> bool: ...
    def pause_all(self) -> None: ...
    def resume_all(self) -> None: ...
    def play_preview(self, file_path: str) -> bool: ...
    def stop_preview(self) -> None: ...
    def is_preview_playing(self, file_path: str = ...) -> bool: ...
    @property
    ...
    @property
    def saturated_sample_count(self) -> int: ...
    @property
    def sample_rate(self) -> int: ...
    @property
...
class GameObject:
    ...
    def can_add_component(self, type_name: str) -> bool: ...
    def get_add_component_blockers(self, type_name: str) -> List[str]: ...
    ...
    def get_component_order(self) -> List[int]: ...
    def set_component_order(self, component_ids: List[int]) -> bool: ...
    def get_component_default_document(self, component: Component) -> Dict[str, Any]: ...
    ...
    def _attach_prepared_py_component(self, component_instance: Any, component_index: int, component_id: int = 0) -> Any: ...
    ...
    def replace_py_component(self, old_component: Any, new_component: Any) -> Any: ...
    ...
    def instantiate(
        ...
        *,
        ...
        instantiate_in_world_space: bool = True,
    ...
    def instantiate(
        ...
        *,
        ...
        parent: Optional[Any] = None,
        instantiate_in_world_space: bool = True,
        return_objects: Literal[False],
    ) -> int: ...
    @staticmethod
    def instantiate(original: Any, *args: Any, **kwargs: Any) -> Any: ...
    @staticmethod
...
class _SceneDocumentReadTicket:
    @property
    def file_state(self) -> DocumentFileState | None: ...
    @property
    def is_complete(self) -> bool: ...
    @property
...
def _pump_inline_jobs(max_jobs: int = 64) -> int: ...
...
class _SceneCommitToken:
    ...
    @property
    def object_id_remap(self) -> Dict[int, int]: ...
    def rollback(self) -> bool: ...
    def finalize(self) -> None: ...


class _ScenePlayModeSnapshot:
    def _python_component_records(self) -> Tuple[set[int], set[Tuple[int, str]], List[Tuple[int, str, Dict[str, Any]]]]: ...
    def _preflight_resource_dependencies(self) -> None: ...
...
class Scene:
    ...
    def create_primitives_batch(
        self,
        type: PrimitiveType,
        count: int,
        name_prefix: str = "",
        with_colliders: bool = True,
    ) -> List[GameObject]: ...
    ...
    def find_objects_with_component(self, type_name: str) -> List[GameObject]: ...
    ...
    def serialize(self) -> str: ...
    def serialize_document(self) -> Dict[str, Any]: ...
    def _capture_play_mode_snapshot(self) -> _ScenePlayModeSnapshot: ...
    def _commit_document(self, document: Dict[str, Any]) -> bool: ...
    def _commit_document_retaining_world(self, document: Dict[str, Any]) -> Optional[_SceneCommitToken]: ...
    def _commit_play_mode_snapshot_retaining_world(
        self, snapshot: _ScenePlayModeSnapshot
    ) -> Optional[_SceneCommitToken]: ...
...
class NativeRuntimeFrameBarrier(IntEnum):
    TRANSFORM_TO_PHYSICS: ClassVar[NativeRuntimeFrameBarrier]
    PHYSICS_SIMULATION: ClassVar[NativeRuntimeFrameBarrier]
    PHYSICS_TO_TRANSFORM: ClassVar[NativeRuntimeFrameBarrier]
    TRANSFORM_RESOLVE: ClassVar[NativeRuntimeFrameBarrier]
    FINAL_TRANSFORM_RESOLVE: ClassVar[NativeRuntimeFrameBarrier]
    ANIMATION_TIMELINE: ClassVar[NativeRuntimeFrameBarrier]
    RENDER_EXTRACTION: ClassVar[NativeRuntimeFrameBarrier]
    RENDER_GRAPH: ClassVar[NativeRuntimeFrameBarrier]
    SNAPSHOT_PUBLICATION: ClassVar[NativeRuntimeFrameBarrier]
    PENDING_DESTROY: ClassVar[NativeRuntimeFrameBarrier]
...
class SceneManager:
    ...
    def _create_preview_scene(self, name: str) -> Scene: ...
    def _close_preview_scene(self, scene: Scene) -> None: ...
    def _get_preview_scenes(self) -> List[Scene]: ...
    def unload_scene(self, scene: Scene) -> None: ...
    def get_active_scene(self) -> Optional[Scene]: ...
    def get_runtime_persistent_scene(self) -> Optional[Scene]: ...
    def find_runtime_object_by_id(self, id: int) -> Optional[GameObject]: ...
    def set_active_scene(self, scene: Scene) -> None: ...
    def prepare_active_scene_replacement(self) -> None: ...
    def mark_temporal_discontinuity(self) -> None: ...
    def get_scene(self, name: str) -> Optional[Scene]: ...
    def get_scene_by_world_id(self, world_id: int) -> Optional[Scene]: ...
    def get_scene_at(self, index: int) -> Optional[Scene]: ...
    def move_scene_adjacent(self, dragged_world_id: int, target_world_id: int, after: bool) -> bool: ...
    def find_runtime_object(self, name: str) -> Optional[GameObject]: ...
    def find_runtime_object_with_tag(self, tag: str) -> Optional[GameObject]: ...
    def find_runtime_objects_with_tag(self, tag: str) -> List[GameObject]: ...
    def find_runtime_objects_in_layer(self, layer: int) -> List[GameObject]: ...
    def move_game_object_to_scene(self, game_object: GameObject, destination: Scene) -> None: ...
    @property
    def scene_count(self) -> int: ...
    def is_playing(self) -> bool: ...
    def set_runtime_lifecycle_callbacks(
        self,
        begin_frame: Callable[[], None],
        fixed_update: Callable[[float], None],
        update: Callable[[float], None],
        late_update: Callable[[float], None],
        editor_update: Callable[[float], None],
        end_frame: Callable[[], None],
    ) -> None: ...
    def set_runtime_frame_barrier_callback(
        self,
        callback: Callable[[NativeRuntimeFrameBarrier], None],
    ) -> None: ...
    def clear_runtime_lifecycle_callbacks(self) -> None: ...
    def play(self) -> None: ...
    def _start_active_scene_for_play(self) -> None: ...
    def _start_scene_for_play(self, scene: Scene) -> None: ...
    def stop(self) -> None: ...
    def pause(self) -> None: ...
    def is_paused(self) -> bool: ...
    ...
    def step(self, delta_time: float = 0.016) -> None:
        """Advance one shared fixed-physics bundle while paused.

        The call is a no-op while Play is running, so manual stepping cannot
        advance a second World beside the automatic accumulator. A successful
        step runs the normal fixed, physics-pre, physics-post, update and
        late-update phases in that order.
        """
        ...
    ...
    def get_global_transform_serial(self) -> int: ...
...
class InxMaterial:
    ...
    def set_float_array(self, name: str, values: Sequence[float]) -> None: ...
    def set_vector4_array(self, name: str, values: Sequence[Sequence[float]]) -> None: ...
    def set_texture_guid(self, name: str, texture_guid: str) -> None: ...
    def set_buffer(self, name: str, buffer: _ComputeBuffer | None) -> None: ...
    def get_buffer(self, name: str) -> _ComputeBuffer | None: ...
...
class AssetDatabase:
    ...
    def configure_blender_import(self, executable: str, export_script: str) -> None: ...
    ...
    def flush_derived_index(self, wait_for_pending_scan: bool = True) -> None: ...
    def import_asset(self, path: str) -> AssetMutationResult: ...
    def reimport_asset(self, path: str, settings: dict | None = None) -> AssetMutationResult: ...
    def begin_model_reimport(self, path: str, settings: dict) -> None: ...
    def try_commit_model_reimport(self) -> AssetMutationResult | None: ...
    def discard_model_reimport(self) -> None: ...
    ...
    @property
    def last_model_reimport_worker_ms(self) -> float: ...
    @property
    def last_model_reimport_prepare_ms(self) -> float: ...
    @property
    def last_model_reimport_persistence_ms(self) -> float: ...
    @property
    def last_model_reimport_live_publication_ms(self) -> float: ...
    @property
...
class AssetRegistry:
    ...
    def create_runtime_mesh(self, name: str = "Mesh") -> InxMesh: ...
    def copy_mesh(self, guid: str, name: str = "") -> InxMesh: ...
    def destroy_runtime_mesh(self, guid: str) -> None: ...
    def set_mesh_data(self, guid: str, positions: np.ndarray, indices: np.ndarray, normals: Optional[np.ndarray] = None, uvs: Optional[np.ndarray] = None, tangents: Optional[np.ndarray] = None, colors: Optional[np.ndarray] = None, submeshes: Optional[List[Dict[str, Any]]] = None, material_slots: List[str] = ...) -> None: ...
    def update_mesh_vertices(self, guid: str, first: int, positions: Optional[np.ndarray] = None, normals: Optional[np.ndarray] = None, uvs: Optional[np.ndarray] = None, tangents: Optional[np.ndarray] = None, colors: Optional[np.ndarray] = None) -> None: ...
    def recalculate_mesh_normals(self, guid: str) -> None: ...
    def recalculate_mesh_tangents(self, guid: str) -> None: ...
    def update_mesh_positions(self, guid: str, first: int, positions: np.ndarray, normals: Optional[np.ndarray] = None) -> None:
        """Publish (N, 3) positions and optional normals together; no topology change or collision recook."""
        ...
    def begin_load_mesh_by_guid(self, guid: str) -> AssetLoadTicket: ...
    def begin_load_material_by_guid(self, guid: str) -> AssetLoadTicket: ...
    def begin_load_physic_material_by_guid(self, guid: str) -> AssetLoadTicket: ...
    def begin_load_shader_by_guid(self, guid: str) -> AssetLoadTicket: ...
    def begin_load_audio_by_guid(self, guid: str) -> AssetLoadTicket: ...
    ...
    def remove_asset(self, guid: str) -> None: ...
    def update_loaded_asset_path(self, guid: str, new_path: str) -> None: ...
    def is_loaded(self, guid: str) -> bool: ...
    def get_asset_version(self, guid: str) -> int: ...
    def get_mesh_gpu_view_residency_mask(self, guid: str, runtime_version: int) -> int: ...
...
class ScriptableRenderContext:
    ...
    def update_parameter_blocks(self, updates: List[GraphParameterBlockUpdate]) -> None: ...
...
class RenderPipelineCallback:
    ...
    def __init__(self) -> None: ...
    def render(self, context: ScriptableRenderContext, camera: Camera) -> None: ...
...
class DrawParameterBlock:
    ...
    def set_float(self, name: str, value: float) -> None: ...
    def set_int(self, name: str, value: int) -> None: ...
    def set_vector2(self, name: str, value: Sequence[float]) -> None: ...
    def set_vector3(self, name: str, value: Sequence[float]) -> None: ...
    def set_vector4(self, name: str, value: Sequence[float]) -> None: ...
    def set_color(self, name: str, value: Sequence[float]) -> None: ...
    def set_matrix(self, name: str, value: Any) -> None: ...
    def set_float_array(self, name: str, values: Sequence[float]) -> None: ...
    def set_vector4_array(self, name: str, values: Sequence[Sequence[float]]) -> None: ...
    def set_texture(self, name: str, texture_guid: str) -> None: ...
    def set_buffer(self, name: str, buffer: _ComputeBuffer) -> None: ...
...
class RendererSelection:
    def __init__(self, material: InxMaterial) -> None: ...
    def set(self, renderer: MeshRenderer, submesh: int = -1, parameters: DrawParameterBlock | None = None) -> None: ...
...
class DepthCompare(IntEnum):
    NEVER: DepthCompare
    LESS: DepthCompare
    EQUAL: DepthCompare
    LESS_EQUAL: DepthCompare
    GREATER: DepthCompare
    NOT_EQUAL: DepthCompare
    GREATER_EQUAL: DepthCompare
    ALWAYS: DepthCompare
...
class GraphParameterBlockUpdate:
    """Revisioned runtime values for one graph parameter block."""
...
class InxGUIContext:
    ...
    def selectable_list_clipped(self, items: Sequence[str]) -> int: ...
    def list_box(
    ...
    def set_scroll_x(self, scroll_x: float) -> None: ...
    ...
    def render_compact_section_header(
        self, label: str, icon_id: int, default_open: bool, open_condition: int,
        allow_overlap: bool, frame_pad_x: float, frame_pad_y: float,
        item_spacing_x: float, item_spacing_y: float, border_size: float,
        zero_indent: bool, font_scale: float, right_margin: float,
        icon_size: float, header_color: Tuple[float, float, float, float],
        hover_color: Tuple[float, float, float, float],
        active_color: Tuple[float, float, float, float], use_text_color: bool,
    ...
    def begin_tab_item(self, label: str, selected: bool = False) -> bool: ...
    ...
    def is_virtualized_region_visible(self, height: float) -> bool: ...
    def set_cursor_pos_x(self, x: float) -> None: ...
    def set_cursor_pos_y(self, y: float) -> None: ...
    def set_cursor_screen_pos(self, x: float, y: float) -> None: ...
    ...
    def begin_drag_drop_target_rect(
        self, min_x: float, min_y: float, max_x: float, max_y: float, target_id: str
    ) -> bool: ...
    ...
    def render_property_batch_plan_values(self, plan: PropertyBatchPlan, values: Sequence[object], label_width: float) -> Dict[int, object]: ...
    def render_material_top(
        self, shader_section_label: str, vertex_label: str, vertex_display: str,
        fragment_label: str, fragment_display: str, shader_label_width: float,
        surface_section_label: str, surface_plan: PropertyBatchPlan,
    ...
    def render_object_field_chrome(self, field_id: str, display_text: str, type_hint: str, selected: bool = False, clickable: bool = True, has_picker: bool = False, picker_texture_id: int = 0, semantic_id: str = "", fixed_width: float = 0.0) -> int: ...
    def render_mesh_renderer_inspector_fields(
        self, mesh_field_id: str, mesh_label: str, mesh_display: str,
        slot_labels: Sequence[str], slot_displays: Sequence[str],
        picker_texture_id: int, label_width: float,
    ) -> List[Dict[str, Any]]: ...
...
class ConsolePanel(EditorPanel):
    ...
    def _get_visible_log_snapshot(self, limit: int) -> list[dict[str, object]]: ...

    @property
    def _selected_uid(self) -> int: ...
    @property
...
class StatusBarPanel(InxGUIRenderable):
    ...
    def set_engine_status(
        self, text: str, progress: float, kind: str = "activity",
    ) -> None: ...
...
class ToolbarPanel(EditorPanel):
    ...
    def set_camera_settings(self, settings: Dict[str, Any]) -> None: ...
...
class InspectorObjectInfo:
    ...
    prefab_guid: str
    hide_transform: bool
    hide_transform_scale: bool
    driven_transform_properties: int
...
class _UICommandPacket: ...

class UIShaderMaterialBinding:
    @property
    ...
    @property
    def base_color(self) -> tuple[float, float, float, float]: ...
    @property
...
class InxScreenUIRenderer:
    def command_packet_epoch(self) -> list[int]: ...
    def begin_command_packet(self) -> None: ...
    def end_command_packet(self) -> _UICommandPacket: ...
    def abort_command_packet(self) -> None: ...
    def append_command_packets(self, packets: list[_UICommandPacket]) -> None: ...
    def set_material_binding(
        self, list: ScreenUIList, material_guid: str, generation: int, pipeline_key: str,
    ) -> None: ...
    @overload
    def set_material_binding(
        self, list: ScreenUIList, material_guid: str, generation: int, pipeline_key: str,
        base_color: tuple[float, float, float, float], alpha_clip_enabled: bool = ...,
        alpha_clip_threshold: float = ...,
    ) -> None: ...
    def command_bindings(self, list: ScreenUIList) -> list[UIShaderMaterialBinding]: ...
    def begin_world_object(self, object: GameObject, pivot_x: float, pivot_y: float,
                           always_on_top: bool = ..., billboard: bool = ...,
                           constant_screen_size: bool = ..., ignored_occluder_id: int = ...) -> None: ...
    def begin_screen_object(self, object: GameObject, list: ScreenUIList, pivot_x: float, pivot_y: float,
                            scale_x: float = ..., scale_y: float = ...) -> None: ...
    def end_screen_object(self) -> None: ...
    """GPU-based 2D screen-space UI renderer."""

    def begin_frame(self, width: int, height: int) -> None: ...
    def begin_frame_cached(self, width: int, height: int, content_revision: int) -> bool: ...
    def push_clip_rect(
        self, list: ScreenUIList, min_x: float, min_y: float, max_x: float, max_y: float,
    ) -> None: ...
    def pop_clip_rect(self, list: ScreenUIList) -> None: ...
    def begin_world_element(
        self, local_to_world: Sequence[float], pivot_x: float, pivot_y: float,
        layer_mask: int = ..., always_on_top: bool = ...,
        billboard: bool = ..., constant_screen_size: bool = ...,
    ) -> None: ...
    ...
    def add_filled_rect(
        ...
        rotation: float = 0.0, mirror_h: bool = False, mirror_v: bool = False,
    ) -> None: ...
...
class _ComputeBuffer:
    @property
    def byte_size(self) -> int: ...
    @property
    def last_write_serial(self) -> int: ...
    @property
    ...
    def set_bytes(self, value: bytes, offset: int = 0) -> None: ...
    def get_bytes(self, byte_size: int, offset: int = 0) -> bytes: ...

class _ComputeKernel:
    @property
    def buffer_binding_count(self) -> int: ...
    @property
    def buffer_bindings(self) -> list[int]: ...
    @property
    def push_constant_bytes(self) -> int: ...
    def dispatch(
        self,
        buffers: list[_ComputeBuffer],
        push_constants: bytes = b"",
        group_count_x: int = 1,
        group_count_y: int = 1,
        group_count_z: int = 1,
    ) -> None: ...
    def get_vertex_buffer_data(self) -> Any: ...
    def set_vertex_buffer(self, buffer: _ComputeBuffer, bounds_min: Vector3, bounds_max: Vector3) -> None: ...
...
class _ComputeHost:
    ...
    def create_buffer(self, element_count: int, scalar_type: str, lanes: int = 1) -> _ComputeBuffer: ...
    def create_kernel(
        self, spirv: bytes, buffer_binding_count: int, push_constant_bytes: int = 0
    ) -> _ComputeKernel: ...
    def create_kernel_with_bindings(
        self, spirv: bytes, buffer_bindings: list[int], push_constant_bytes: int = 0
    ) -> _ComputeKernel: ...
    def _create_kernel_from_compiler(
        self, spirv: bytes, bindings: list[tuple[int, str]], push_constant_bytes: int = 0
    ) -> _ComputeKernel: ...
    def dispatch_batch(
        self,
        dispatches: list[
            tuple[_ComputeKernel, list[_ComputeBuffer], bytes, int, int, int]
        ],
        updates: list[tuple[_ComputeBuffer, bytes, int]] = ...,
    ) -> None: ...
    def dispatch_batch_and_read(
        self,
        dispatches: list[
            tuple[_ComputeKernel, list[_ComputeBuffer], bytes, int, int, int]
        ],
        updates: list[tuple[_ComputeBuffer, bytes, int]],
        reads: list[tuple[_ComputeBuffer, int, int]],
    ) -> list[bytes]: ...
    def set_profiling_enabled(self, enabled: bool) -> bool: ...
...
class Infernux:
    ...
    @property
    def startup_phase_timings_ms(self) -> dict[str, float]: ...
    ...
    def _acquire_compute_host(self) -> _ComputeHost: ...
    def _get_imported_texture_ui_texture_id(self, name: str, texture_guid: str) -> int: ...
    def begin_prepare_linked_shader_programs(
        self, material_guids: list[str]
    ) -> LinkedShaderProgramLoadTicket: ...
    def try_commit_linked_shader_programs(
        self, ticket: LinkedShaderProgramLoadTicket
    ) -> bool: ...
    @property
    ...
    @property
    def resident_mesh_vertex_buffer_count(self) -> int: ...
    @property
    ...
    def get_object_mesh_index_gpu_info(self, object_id: int) -> dict[str, object]: ...
    ...
    def get_renderer_performance_window(self) -> dict[str, Any]: ...
    @property
    def renderer_ui_performance_snapshot(self) -> dict[str, Any]: ...
    @property
    def preview_task_snapshots(self) -> list[dict[str, Any]]: ...
    @property
    ...
    def is_shader_loaded(self, shader_id: str, shader_type: str) -> bool: ...
    ...
    def render_model_animation_preview(self, mesh: InxMesh, take: str, seconds: float,
                                       size: int = 256, dependency_revision: int = 0) -> int: ...
    def poll_gpu_completions(self) -> None: ...
    def query_or_schedule_material_preview(self, resource_key: str, mat_file_path: str,
                                           material_json: str = "", file_mtime_hint: int = 0,
                                           authoring: bool = False) -> int: ...
    def query_or_schedule_mesh_preview(self, resource_key: str, mesh_file_path: str,
                                       file_mtime_hint: int = 0) -> int: ...
    def get_material_preview_texture_id(self, resource_key: str) -> int: ...
    def is_material_preview_ready(self, resource_key: str) -> bool: ...
    def get_texture_preview_texture_id(self, resource_key: str) -> int: ...
    def get_mesh_preview_texture_id(self, resource_key: str) -> int: ...
    ...
    def release_preview_authoring(self, resource_key: str) -> None: ...
    ...
    def invalidate_temporal_history(self, scene_view: bool = True, game_view: bool = True) -> None: ...
    ...
    def get_editor_rect_frame(self) -> Optional[Dict[str, Any]]: ...
    def set_editor_rect_frame_override(
        self, object_id: int, center: Sequence[float], axis_u: Sequence[float],
        axis_v: Sequence[float], half_size: Sequence[float],
        axis_indices: Sequence[int] = (0, 1),
    ) -> None: ...
    def clear_editor_rect_frame_override(self) -> None: ...
    ...
    def clear_component_cpu_gizmos(self) -> None: ...
    def upload_component_resident_gizmos(self, descriptors: Sequence[Any]) -> None: ...
    ...
    def _gpu_particle_artifact_revision(self, emitter_id: int) -> int: ...
    def _gpu_particle_state_was_preserved(self, emitter_id: int) -> bool: ...
    def _gpu_particle_output_count(self, emitter_id: int) -> int: ...
    def _gpu_particle_output_render_queue(self, emitter_id: int, output_id: int) -> int: ...
    ...
    @property
    def msaa_state(self) -> dict[str, Any]: ...
...
class RaycastHit:
    ...
    @property
    def sub_shape_id(self) -> int: ...
    @property
    def triangle_index(self) -> Optional[int]: ...
    @property
    def game_object(self) -> GameObject: ...
    @property
    def collider(self) -> Collider: ...
...
class Collider(Component):
    ...
    def raycast(self, origin: Vector3, direction: Vector3, max_distance: float = 1000.0) -> Optional[RaycastHit]: ...
...
class MeshCollider(Collider):
    ...
    shape_error: str
    is_cooking: bool
    collision_geometry_revision: int
...
class Rigidbody(Component):
    ...
    def get_point_velocity(self, point: Vector3) -> Vector3: ...
    def get_point_velocities(self, points: npt.NDArray[np.float32], output: npt.NDArray[np.float32]) -> npt.NDArray[np.float32]: ...
...
class HingeJoint(Component):
    """Single-axis rigidbody constraint connected to another body or the world."""
...
class SliderJoint(Component):
    """One-axis prismatic constraint connected to another body or the world."""
...
class PenetrationResult:
    ...
    def distance(self) -> float: ...
    @property
    def point_a(self) -> Vector3: ...
    @property
    def point_b(self) -> Vector3: ...
...
class Physics:
    ...
    @staticmethod
    def compute_penetration(collider_a: Collider, position_a: Vector3, rotation_a: quatf,
                            collider_b: Collider, position_b: Vector3, rotation_b: quatf) -> Optional[PenetrationResult]: ...

    @staticmethod
    def get_rigidbody_states(rigidbodies: List[Rigidbody], output: Optional[dict[str, Any]] = ...) -> dict[str, Any]: ...

    @staticmethod
    def _write_rigidbody_state_buffers(rigidbodies: List[Rigidbody], output: dict[str, _ComputeBuffer]) -> None: ...

    @staticmethod
    def _write_rigidbody_state_and_box_state_buffers(
        rigidbodies: List[Rigidbody], state_output: dict[str, _ComputeBuffer],
        box_output: dict[str, _ComputeBuffer], query_triggers: bool = ...,
    ) -> int: ...

    @staticmethod
    def get_rigidbody_box_states(rigidbodies: List[Rigidbody], output: Optional[dict[str, Any]] = ...,
                                 query_triggers: bool = ...) -> dict[str, Any]: ...

    @staticmethod
    def _write_rigidbody_box_state_buffers(rigidbodies: List[Rigidbody], output: dict[str, _ComputeBuffer],
                                          query_triggers: bool = ...) -> int: ...
    ...
    @staticmethod
    def apply_rigidbody_impulses(rigidbodies: List[Rigidbody], linear_impulses: npt.NDArray[np.float32],
                                angular_impulses: npt.NDArray[np.float32]) -> None: ...
    ...
    @staticmethod
    def _apply_rigidbody_impulse_buffers(rigidbodies: List[Rigidbody], linear_impulses: _ComputeBuffer,
                                        angular_impulses: _ComputeBuffer) -> None: ...
    ...
    @staticmethod
    def ignore_collision(collider1: Collider, collider2: Collider, ignore: bool = True) -> None: ...
    @staticmethod
    def get_ignore_collision(collider1: Collider, collider2: Collider) -> bool: ...
    @staticmethod
...
class InputManager:
    ...
    def set_cursor_confined(self, confined: bool) -> None: ...
    @property
    def is_cursor_confined(self) -> bool: ...
    def warp_cursor(self, x: float, y: float) -> bool: ...
...
def _create_scene_transform_batch_handle(
    scene: Scene,
    name_prefix: str = "",
    mode: TransformBatchMode = ...,
) -> TransformBatchHandle: ...


def _cds_register_class(name: str) -> int: ...
def _cds_register_field(class_id: int, name: str, type_code: int) -> int: ...
def _cds_schema_begin() -> int: ...
def _cds_schema_prepare_class(transaction_id: int, name: str) -> int: ...
def _cds_schema_prepare_field(transaction_id: int, candidate_id: int, name: str, type_code: int) -> int: ...
def _cds_schema_has_class(transaction_id: int, candidate_id: int) -> bool: ...
def _cds_schema_find_class(transaction_id: int, name: str) -> Optional[int]: ...
def _cds_schema_get_field_id(transaction_id: int, candidate_id: int, name: str) -> Optional[int]: ...
def _cds_schema_discard_class(transaction_id: int, candidate_id: int) -> bool: ...
def _cds_schema_reserve(transaction_id: int, candidate_id: int, capacity: int) -> None: ...
def _cds_schema_alloc(transaction_id: int, candidate_id: int) -> Tuple[int, int]: ...
def _cds_schema_free(transaction_id: int, candidate_id: int, slot: Tuple[int, int]) -> None: ...
def _cds_schema_is_alive(transaction_id: int, candidate_id: int, slot: Tuple[int, int]) -> bool: ...
def _cds_schema_get(transaction_id: int, candidate_id: int, field_id: int, slot: Tuple[int, int], type_code: int) -> Any: ...
def _cds_schema_set(transaction_id: int, candidate_id: int, field_id: int, slot: Tuple[int, int], type_code: int, value: Any) -> None: ...
def _cds_schema_migrate_slot(transaction_id: int, candidate_id: int, source_class_id: int, source_slot: Tuple[int, int], field_map: List[Tuple[int, int]]) -> Tuple[int, int]: ...
def _cds_schema_seal(transaction_id: int) -> Dict[int, int]: ...
def _cds_schema_final_class_id(transaction_id: int, candidate_id: int) -> Optional[int]: ...
def _cds_schema_commit(transaction_id: int) -> Dict[int, int]: ...
def _cds_schema_finalize(transaction_id: int) -> bool: ...
def _cds_schema_rollback(transaction_id: int) -> bool: ...
def _cds_schema_active(transaction_id: int) -> bool: ...
def _cds_alloc(class_id: int) -> Tuple[int, int]: ...
def _cds_free(class_id: int, slot: Tuple[int, int]) -> None: ...
def _cds_is_alive(class_id: int, slot: Tuple[int, int]) -> bool: ...
